package org.baps.api.demo.exceptions.handlers;

import static org.springframework.core.Ordered.HIGHEST_PRECEDENCE;

import org.baps.api.demo.exceptions.AuthenticationException;
import org.baps.api.demo.exceptions.AuthorizationException;
import org.baps.api.demo.exceptions.DataAlreadyExistsException;
import org.baps.api.demo.exceptions.DataNotFoundException;
import org.baps.api.demo.exceptions.DataValidationException;
import org.baps.api.demo.exceptions.GenericException;
import org.baps.api.demo.exceptions.InvalidCredentialsException;
import org.baps.api.demo.models.error.Error;
import org.baps.api.demo.models.error.ErrorType;
import org.baps.api.demo.models.responses.ApiErrorResponse;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        final ApiErrorResponse errorResponse = getApiErrorResponse(Stream.concat(fieldErrorStream, globalErrorStream).toList());
